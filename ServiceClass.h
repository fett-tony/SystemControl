...
enum _INPUT_FOR { MENU_MOVE, LIST_MOVE, SEARCH_INPUT };
enum SeaReq { REQ_RIGHT, REQ_LEFT, REQ_DEL_DC, REQ_DEL_BACKSPACE, REQ_INS_DEFAULT};
enum { UNIT_STATE_DISABLED = 0x01, UNIT_STATE_ENABLED = 0x02, UNIT_STATE_STATIC = 0x03, UNIT_STATE_BAD = 0x04,
       UNIT_STATE_MASKED = 0x05, UNIT_STATE_TMP = 0x06, UNIT_STATE_GENERATED = 0x07, UNIT_SUBSTATE_RUNNING = 0x08,
       UNIT_SUBSTATE_CONNECTED = 0x09, UNIT_SUBSTATE_INVALID = 0x0a, UNIT_SUBSTATE_TMP = 0x0b, UNIT_SUBSTATE_DEAD = 0x0c,
       UNIT_SUBSTATE_EXITED = 0x0d, UNIT_LOADSTATE_LOADED = 0x0e, UNIT_LOADSTATE_NOTFOUND = 0x0f, UNIT_LOADSTATE_UNLOAD = 0x10,
       UNIT_ACTIVESTATE_ACTIVE = 0x11, UNIT_ACTIVESTATE_INACTIVE = 0x12 };
enum STATE_FLAGS { STATE_FLAGS_ENABLE, STATE_FLAGS_DISABLE, STATE_FLAGS_DISABLE_ISO };
